...
const movieData = {
    'interstellar': {
        ...
        image: 'images/movies/movie-the pursuit of happyness2.jpg',
        ...
        thoughts: [
            '这部电影根据真实故事改编，讲述了主人公克里斯在事业受挫、妻子离去、无家可归的人生绝境中，独自抚养儿子，咬牙拼搏，最终入职证券公司，扭转人生的励志故事。多数观众将影片内核简单归为坚持、努力与梦想，认为只要不懈奋斗就能收获成功。但在我看来，影片实际传递的核心主旨是<span class="review-highlight">"是金子总能发光"</span>，克里斯的逆袭绝非单纯努力的结果。过人的天分，才是他突破困境、收获成功的核心关键。',
            '影片多处细节，直白地展现了克里斯远超常人的天赋和智商，这是普通人难以复刻的优势。初次接触魔方时，他仅凭妻子的简单规则讲解，无任何专业教程，便依靠极强的推理能力和空间想象力，短时间内自行摸索出还原方法。后续在出租车内，他快速完整地还原魔方，凭借这份亮眼的能力惊艳了证券公司高管，为他赢得了宝贵的面试机会。若无这份天赋，他的求职简历会淹没在海量文件中，像废纸一样被扔进垃圾桶，根本没有展露自我的可能。',
            '不止于此，克里斯的学霸特质贯穿始终。影片提到，他年少时就能快速吃透整本数学课本；拥有超强的瞬时记忆力，能秒记很长的电话号码；学生时代和参军时成绩都是第一名；在人生最窘迫的阶段，他一边奔波售卖扫描仪，一边安顿居所，照顾年幼的儿子，只能挤占碎片化的深夜时间备考证券公司岗位，却依旧能轻松完成考试、脱颖而出。足以可见，他成功的根基，是与生俱来的过人天分。',
            '我从不否认努力与坚持的价值，影片传递的永不言弃、守护梦想的信念，依旧值得每个人学习。片中有一句台词：<span class="review-highlight">"Don\'t ever let somebody tell you… you can\'t do something. You got a dream, you gotta protect it."</span> 它是克里斯人生的真实写照。绝境之中，他没有像普通人一样沉沦颓废，而是始终坚守希望，负重前行，强大的心智韧性为他的成功保驾护航。但不可忽视的是，世间身处逆境、努力拼搏的人数不胜数，却极少有人能像他一样逆风翻盘。',
            '<span class="review-highlight">究其根本，努力是人人可践行的常态，而天分是稀缺的核心壁垒。</span>克里斯的坚持固然可贵，但真正让他抓住机遇、突破阶层的，是他过人的头脑。正是因为他本身是"金子"，拥有亮眼的天赋底色，日复一日的坚持才有了落地生根、开花结果的可能。同时，奋斗与梦想同样不可或缺，这份坚守与努力打磨了他的天赋，抵御了苦难。天赋为成功铺路，努力为天赋赋能，二者相融，终让微光成炬。'
        ],
        signature: 'XueXue<br>2026年8月28日'
    },
    'parasite': {
        title: '🎬 寄生虫',
        subtitle: 'Parasite',
    ...
    cards.forEach(card => {
        card.addEventListener('click', function() {
            ...
            if (Array.isArray(data.thoughts)) {
                modalThoughts.innerHTML = data.thoughts.map(p => `<p>${p}</p>`).join('');
            } else {
                modalThoughts.textContent = data.thoughts;
            }
            if (data.signature) {
                const sig = document.createElement('p');
                sig.className = 'movie-modal-signature';
                sig.innerHTML = `—— ${data.signature}`;
                modalThoughts.appendChild(sig);
            }
